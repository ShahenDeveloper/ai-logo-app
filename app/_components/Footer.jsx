...
const Footer = () => {
  return (
<section className="bg-gray-50 py-12 mt-32 w-full">
      ...
      <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
        <div className="">
          <Button
            size={"lg"}
            variant={"link"}
            className="w-full min-[400px]:w-auto bg-gradient-to-r from-slate-900 to-rose-500 hover:to-slate-900 hover:text-white text-white translate-all duration-300"
          >
            <Link
